...
class AppTextStyles {
  ...
  static final TextStyle heading20 = heading.copyWith(
    fontSize: 20,
  );
  ...
  static final TextStyle heading2_15 = GoogleFonts.notoSans(
    color: AppColors.black,
    fontSize: 15,
  ...
  static final TextStyle body15 = AppTextStyles.body.copyWith(fontSize: 15);
  ...
  static final TextStyle bodyDarkGreen = bodyDark.copyWith(
    color: AppColors.darkGreen,
  );

  static final TextStyle bodyDarkRed = bodyDark.copyWith(
  ...
  static final TextStyle bodyLightGrey15 =
      AppTextStyles.bodylightGrey.copyWith(fontSize: 15);
